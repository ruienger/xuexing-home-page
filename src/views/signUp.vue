<template>
  <div>
    ...
    <div class="content-wrapper">
      <el-page-header @back="$router.push({ name: 'Home' })" content="项目报名">
      </el-page-header>
      <div class="project-wrapper" style="display: flex;">
        <el-image
        ...
        <div style="padding: 0 2em;display:flex;flex-direction:column;justify-content:space-between">
          <div><h2 v-html="project.name"></h2></div>
          <div><h3>适合 18+ 周岁, 游学行程 3 个月</h3></div>
      ...
      >
        ...
        <el-form-item label="现住址">
          ...
          ></el-col>
          <el-col :span="2" style="text-align: center"> 区/县</el-col>
        </el-form-item>
